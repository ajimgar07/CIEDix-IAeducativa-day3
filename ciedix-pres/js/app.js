...
(function () {
    ...
    /* --- QR flotante: visible a partir da slide 12, respectando
           data-hide-qr="true" en slides individuais ------------------- */
    function updateQRVisibility(event) {
        ...
        // Ocultar explicitamente en slides que o pidan
    ...
    function activateVideoThumbnails() {
        ...
        thumbs.forEach(thumb => {
            // Evitar dobre-rexistro se a función se chama varias veces
            ...
            const playVideo = () => {
                ...
                // Substituír contido por iframe que reproduce automaticamente
                const iframe = document.createElement('iframe');
                iframe.setAttribute('src', src);
                iframe.setAttribute('title', thumb.getAttribute('aria-label') || 'Vídeo');
                ...
                // Limpar thumbnail e poñer o iframe
                thumb.innerHTML = '';
                thumb.classList.remove('video-thumb');
    ...
    function renderComplianceMatrix() {
        ...
        target.innerHTML = `
            ...
            <div class="compliance-caption">
                <span class="lang-gl">Fonte: revisión interna CIEDixlab · 11 modelos avaliados · 3 aprobados inmediatamente.</span>
                <span class="lang-es">Fuente: revisión interna CIEDixlab · 11 modelos evaluados · 3 aprobados inmediatamente.</span>
            </div>`;
    }
